...
"""
def check_question(keywords, p_keywords,text):
    if all(word in text for word in p_keywords):
...
# check if the question is a valid one
check_question(keywords, preprocessed_keyword, preprocessed_text)
